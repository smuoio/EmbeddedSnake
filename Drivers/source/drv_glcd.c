 ...
 *
 *************************************************************************/
void LCDSetFont(pFontType_t pFont, LdcPixel_t Color, LdcPixel_t BackgndColor)
{
  pCurrFont = pFont;
  TextColour = Color;
 ...
 *
 ************************************************************************/
void LCDDrawPixel ( Int32U x, Int32U y, LdcPixel_t Color ) {
   Int32U k;
   k = x | ( x << 8 );
 ...
 *
 ************************************************************************/
void LCDDrawLine( Int32U x0, Int32U y0, Int32U x1, Int32U y1, LdcPixel_t Color ) {
   int dy = y1 - y0;
   int dx = x1 - x0;
   int stepx, stepy;
 ...
 *
 ************************************************************************/
void LCDDrawCircle( Int32U x0, Int32U y0, Int32U radius, LdcPixel_t Colour ) {
   int f = 1 - radius;
   int ddF_x = 0;
 ...
 *
 ************************************************************************/
void LCDDrawFilledCircle( Int32U x0, Int32U y0, Int32U radius, LdcPixel_t Colour ) {
   Int32U r= 0;
   for ( r = 0; r <= radius; r++ )
 ...
 *
 ************************************************************************/
void LCDDrawRectangle( Int32U x0, Int32U y0, Int32U x1, Int32U y1, LdcPixel_t Colour ) {
 ...
 *
 ************************************************************************/
void LCDDrawFilledRectangle ( Int32U x0, Int32U y0, Int32U x1, Int32U y1, LdcPixel_t Color ) {
   Int32U j,k;
